---
title: "Analisis Pengaruh Nilai Tukar Rupiah Terhadap Volume Ekspor Indonesia Ke RRT (Tahun 2018-2023)"
...
Metode yang dipilih adalah regresi univariat atau Ordinary Least Square (OLS) dengan 2 variabel independen. Penelitian ini merbaksud mencari hubungan antara Jumlah Ekspor dan Nilai Tukar. Spesifikasi yang dilakukan adalah:
...
Pengaruh nilai tukar Rupiah terhadap volume ekspor Indonesia ke RRT menjadi isu penting dalam perdagangan internasional. Fluktuasi nilai tukar dapat memengaruhi daya saing produk Indonesia di pasar global, yang berpotensi berdampak pada jumlah ekspor. Penelitian ini bertujuan untuk menganalisis hubungan antara nilai tukar Rupiah terhadap USD (ntx) sebagai variabel independen dan volume ekspor Indonesia ke RRT (jey) sebagai variabel dependen pada periode 2018-2023.
